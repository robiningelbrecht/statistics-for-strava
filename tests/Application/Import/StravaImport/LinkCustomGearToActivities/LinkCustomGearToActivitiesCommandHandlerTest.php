...
namespace App\Tests\Application\Import\StravaImport\LinkCustomGearToActivities;

use App\Application\Import\StravaImport\LinkCustomGearToActivities\LinkCustomGearToActivities;
use App\Application\Import\StravaImport\LinkCustomGearToActivities\LinkCustomGearToActivitiesCommandHandler;
...
class LinkCustomGearToActivitiesCommandHandlerTest extends ContainerTestCase
{
    ...
    public function testHandleWhenFeatureIsDisabled(): void
    {
        $output = new SpyOutput();
