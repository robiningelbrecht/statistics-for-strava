...
final readonly class DaytimeStats
{
    ...
    public function getData(): array
    {
        ...
        foreach ($this->activities as $activity) {
            ...
            $statistics[$daytime->value]['totalDistance'] = $statistics[$daytime->value]['totalDistance'] + $activity->getDistance()->toFloat();
            $statistics[$daytime->value]['totalElevation'] = $statistics[$daytime->value]['totalElevation'] + $activity->getElevation()->toFloat();
            $statistics[$daytime->value]['movingTime'] = $statistics[$daytime->value]['movingTime'] + $activity->getMovingTimeInSeconds();
