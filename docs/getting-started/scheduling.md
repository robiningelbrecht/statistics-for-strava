...
If you have configured the [daemon](https://docs.getsfs.app/#/getting-started/installation?id=docker-composeyml) container, these commands will run automatically.
